...
def scrape_news_page(
    base_url: str, num_pages: int, title_selector: str, article_selector: str, 
    content_selector: str, class_selector: str, date_selector: str
) -> None:
    """
...
def scrape_news_more(
    base_url: str, more_button_selector: str, title_selector: str, 
    content_selector: str, article_link_selector: str, date_selector: str
) -> None:
    """
